...
user.name = 'RyanHawthorne' # set to your user name
...
ps.file = 'RTutor_1b_ols_sim.Rmd' # name of this file
check.problem.set('RTutor_1b_ols_sim', ps.dir, ps.file, user.name=user.name, reset=FALSE)
```
